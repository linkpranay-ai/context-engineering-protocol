...
shutil.copytree(src / 'ult-cep-wizard', dst / '.github/skills/ult-cep-wizard', dirs_exist_ok=True)
...
1. `python .github/skills/ult-cep-wizard/scripts/wizard_server.py <fixture_root>`
